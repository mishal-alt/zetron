...
const Services = () => {
  return (
    <section id="services" className="py-24 md:py-32 px-6 md:px-12 bg-surface-container-lowest scroll-mt-32">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:justify-between items-start md:items-end mb-20 gap-8">
          <div className="max-w-2xl">
            <span className="font-label text-xs tracking-[0.4em] uppercase text-on-surface-variant mb-6 block">01 / Capabilities</span>
            <h2 className="font-headline text-3xl sm:text-5xl md:text-7xl font-bold text-white tracking-tighter uppercase">CORE SERVICES.</h2>
          </div>
          <div className="text-on-surface-variant font-headline italic text-xl sm:text-2xl">Precision Engineering. Unlimited Scale.</div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 h-auto md:h-[800px]">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="md:col-span-8 bg-surface-container border border-outline-variant/10 p-8 md:p-12 flex flex-col justify-between group overflow-hidden relative"
          >
            ...
            <div>
              <h3 className="text-2xl sm:text-3xl font-headline font-bold text-white mb-6 uppercase tracking-widest">Distributed Systems</h3>
          ...
          <motion.div 
            ...
            className="md:col-span-4 bg-surface p-8 md:p-12 border border-outline-variant/10 flex flex-col justify-between group"
          >
            <div>
          ...
          <motion.div 
            ...
            className="md:col-span-8 bg-surface-container-high p-8 md:p-12 border border-outline-variant/10 flex flex-col md:flex-row gap-12"
          >
